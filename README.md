...
<p align="center">
  <strong>SaaS 多租户 AI 应用开发框架</strong><br/>
  基于 Go + React 的全栈 AI 应用平台，内置插件系统、多租户隔离、LLM 集成
</p>
...
| 特性 | 说明 |
|------|------|
| 🧠 **AI 对话** | 基于 Eino 框架的 LLM 流式对话，支持多种模型后端 |
| 🏢 **多租户** | Schema 级租户隔离，JWT 鉴权贯穿全链路 |
| 🧩 **插件系统** | 前端模块注册 + 后端启用控制，租户级开关 |
| 🔐 **认证授权** | JWT + bcrypt，注册/登录即用 |
...
| **agent-svc** | `:8082` | AI 对话、流式 SSE、历史管理 | Eino + LLM |
...
`agent-svc` 支持多种 LLM 后端，通过环境变量配置：
...
<p align="center">
  用 ❤️ 构建 · AgentMesh · SaaS 多租户 AI 应用开发框架
</p>